...
public abstract class Chart extends AbstractAutogeneratedId<Long> {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ChartIndex other = (ChartIndex) obj;
	...
	public String toString() {
		return "Chart [type=" + type.getTag() + ", histoTimeSpan=" + histoTimeSpan.getTag()
				+ ", histoMovingAverage=" + histoMovingAverage.getTag() + ", histoSize="
				+ histoSize.getTag() + ", intradayWidth=" + intradayWidth
				+ ", intradayHeight=" + intradayHeight + ", internalPath="+internalPath+"]";
	}
}
